module.exports = {
  TOKEN: process.env.TOKEN || "OTUyNDY3OTEyMzg2NTcyMzM4.G7enSE.TXgcRrQreNIZ77xkVDiwUtJRduUkBOZZkVABHU",
  PREFIX: process.env.PREFIX || "x.",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "dev by xtron",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=952467912386572338&permissions=1088811301696&scope=bot`,
