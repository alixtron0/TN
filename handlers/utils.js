...
module.exports = async (client) => {
  ...
  client.playembed = (guild) => {
    let embed = new EmbedBuilder()
      ...
      .setDescription(
        ` [Invite Now](${client.config.links.inviteURL}) • [Support Server](${client.config.links.DiscordServer}) • [Website](https://discord.gg/qagQXgwW2Q)`
      )
      .setImage(
        guild.banner
          ? guild.bannerURL({ size: 4096 })
          : `https://cdn.discordapp.com/attachments/922852136537178143/1011257068101054485/c83cf4593af7031d1c8a132f77bff5fe6790ccc6_hq.gif`
      )
      .setFooter({
        text: guild.name,
